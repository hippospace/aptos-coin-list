...
export class CoinList 
{
  ...
  static fields: FieldDeclType[] = [
  { name: "coin_types", typeTag: new StructTag(new HexString("0x1"), "iterable_table", "IterableTable", [new StructTag(new HexString("0x1"), "type_info", "TypeInfo", []), new StructTag(new HexString("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8"), "coin_list", "Nothing", [])]) }];
...
export class CoinRegistry 
{
  ...
  static fields: FieldDeclType[] = [
  { name: "type_to_coin_info", typeTag: new StructTag(new HexString("0x1"), "iterable_table", "IterableTable", [new StructTag(new HexString("0x1"), "type_info", "TypeInfo", []), new StructTag(new HexString("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8"), "coin_list", "CoinInfo", [])]) }];
...
export class FullList 
{
  ...
  static fields: FieldDeclType[] = [
  { name: "coin_info_list", typeTag: new VectorTag(new StructTag(new HexString("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8"), "coin_list", "CoinInfo", [])) }];
...
export function add_extension_ (
  ...
  registry = $c.borrow_global_mut<CoinRegistry>(new SimpleStructTag(CoinRegistry), new HexString("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8"));
...
export function buildPayload_add_extension (
  ...
  return $.buildPayload(
    "0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::add_extension",
    typeParamStrings,
    [
      $.payloadArg(key),
      $.payloadArg(value),
...
export function buildPayload_add_to_list (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::add_to_list",
    typeParamStrings,
    []
  );
...
export function buildPayload_add_to_registry_by_signer (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::add_to_registry_by_signer",
    typeParamStrings,
    [
      $.payloadArg(name),
      $.payloadArg(symbol),
...
export function buildPayload_create_list (
  ...
  return $.buildPayload(
    "0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::create_list",
    typeParamStrings,
    []
  );
...
export function buildPayload_drop_extension (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::drop_extension",
    typeParamStrings,
    [
      $.payloadArg(key),
      $.payloadArg(value),
...
export function buildPayload_fetch_full_list (
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(
    "0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::fetch_full_list",
    typeParamStrings,
    [
...
export function get_coin_info_ (
  ...
  registry = $c.borrow_global<CoinRegistry>(new SimpleStructTag(CoinRegistry), new HexString("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8"));
  type_info = Aptos_std.Type_info.type_of_($c, [$p[0]]);
...
export function initialize_ (
  ...
  if (!((Std.Signer.address_of_(admin, $c)).hex() === (new HexString("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8")).hex())) {
...
export function buildPayload_initialize (
  ...
  const typeParamStrings = [] as string[];
  return $.buildPayload(
    "0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::initialize",
    typeParamStrings,
    []
  );
...
export function is_registry_initialized_ (
  ...
  return $c.exists(new SimpleStructTag(CoinRegistry), new HexString("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8"));
}
...
export function buildPayload_remove_from_list (
  ...
  const typeParamStrings = $p.map(t=>$.getTypeTagFullname(t));
  return $.buildPayload(
    "0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::remove_from_list",
    typeParamStrings,
    []
  );
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::CoinInfo", CoinInfo.CoinInfoParser);
  repo.addParser("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::CoinList", CoinList.CoinListParser);
  repo.addParser("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::CoinRegistry", CoinRegistry.CoinRegistryParser);
  repo.addParser("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::FullList", FullList.FullListParser);
  repo.addParser("0xf70ac33c984f8b7bead655ad239d246f1c0e3ca55fe0b8bfc119aa529c4630e8::coin_list::Nothing", Nothing.NothingParser);
}
export class App {
  constructor(
