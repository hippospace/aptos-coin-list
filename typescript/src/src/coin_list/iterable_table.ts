...
export class IterableTable 
{
  ...
  { name: "inner", typeTag: new StructTag(new HexString("0x1"), "table_with_length", "TableWithLength", [new $.TypeParamIdx(0), new StructTag(new HexString("0x48265636b9e378f31bfaf20bc5108e894798646e496e1c586eea6dc07dbf84b7"), "iterable_table", "IterableValue", [new $.TypeParamIdx(0), new $.TypeParamIdx(1)])]) },
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0x48265636b9e378f31bfaf20bc5108e894798646e496e1c586eea6dc07dbf84b7::iterable_table::IterableTable", IterableTable.IterableTableParser);
  repo.addParser("0x48265636b9e378f31bfaf20bc5108e894798646e496e1c586eea6dc07dbf84b7::iterable_table::IterableValue", IterableValue.IterableValueParser);
}
export class App {
  constructor(
