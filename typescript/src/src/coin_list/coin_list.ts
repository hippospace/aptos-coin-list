...
export class CoinRegistry 
{
  ...
  { name: "uids", typeTag: new StructTag(new HexString("0x1"), "table", "Table", [new StructTag(new HexString("0x1"), "string", "String", []), new StructTag(new HexString("0xb5d6dbc225e8c42cec66664ebbccaef2098107f699510613a0b90214f659bb46"), "coin_list", "Nothing", [])]) },
  { name: "approvers", typeTag: new VectorTag(AtomicTypeTag.Address) }];
