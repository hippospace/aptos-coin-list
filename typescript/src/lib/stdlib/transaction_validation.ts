...
export function initialize_ (
  ...
  $c.move_to(new SimpleStructTag(TransactionValidation), aptos_framework, new TransactionValidation({ module_addr: new HexString("0x1"), module_name: [u8("116"), u8("114"), u8("97"), u8("110"), u8("115"), u8("97"), u8("99"), u8("116"), u8("105"), u8("111"), u8("110"), u8("95"), u8("118"), u8("97"), u8("108"), u8("105"), u8("100"), u8("97"), u8("116"), u8("105"), u8("111"), u8("110")], script_prologue_name: $.copy(script_prologue_name), module_prologue_name: $.copy(module_prologue_name), multi_agent_prologue_name: $.copy(multi_agent_prologue_name), user_epilogue_name: $.copy(user_epilogue_name) }, new SimpleStructTag(TransactionValidation)));
  return;
}
...
export function multi_agent_script_prologue_ (
  ...
  if (!(Vector.length_(secondary_signer_public_key_hashes, $c, [new VectorTag(AtomicTypeTag.U8)])).eq(($.copy(num_secondary_signers)))) {
  ...
  while (($.copy(i)).lt($.copy(num_secondary_signers))) {
    {
      ...
      signer_public_key_hash = $.copy(Vector.borrow_(secondary_signer_public_key_hashes, $.copy(i), $c, [new VectorTag(AtomicTypeTag.U8)]));
