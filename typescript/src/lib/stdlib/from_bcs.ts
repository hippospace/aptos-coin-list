...
export function to_string_ (
  v: U8[],
  $c: AptosDataCache,
): String.String {
  let s;
  s = from_bytes_($.copy(v), $c, [new StructTag(new HexString("0x1"), "string", "String", [])]);
